...
func NewRandomSolution(ctx context.Context, model nextroute.Model) (nextroute.Solution, error) {
...
func RandomSolutionConstruction(ctx context.Context, s nextroute.Solution) (nextroute.Solution, error) {
	solution := s.Copy()
