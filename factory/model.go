...
type Options struct {
	...
	Objectives struct {
		...
		Distance                 float64 `json:"distance" usage:"factor to weigh the travel distance objective" default:"0.0"`
		...
		StopBalance              float64 `json:"stop_balance" usage:"factor to weigh the stop balance objective" default:"0.0"`
	} `json:"objectives"`
	Properties struct {
		Disable struct {
